...
const translations = {
  "pt-BR": {
    ...
    "builder.tree": "Árvore",
    "builder.hideComponentTree": "Ocultar Árvore de Componentes",
    "builder.payAndPublish": "Pagar e Publicar",
    "builder.publishing": "Publicando...",
    "builder.unpublishPage": "Despublicar Página",
    "builder.unpublishing": "Despublicando...",
    "builder.publishPage": "Publicar Página",
    "builder.viewLivePage": "Ver Página Online",
    "builder.updating": "Atualizando...",
    "builder.liveAt": "Online em:",
    "builder.status": "Status:",
    "builder.readyToPublish": "Pronto para publicar",
    "builder.desktopView": "Visualização Desktop",
    "builder.tabletView": "Visualização Tablet",
    "builder.mobileView": "Visualização Móvel",
    "builder.resetZoom": "Redefinir zoom",
  ...
  en: {
    ...
    "builder.tree": "Tree",
    "builder.hideComponentTree": "Hide Component Tree",
    "builder.payAndPublish": "Pay & Publish",
    "builder.publishing": "Publishing...",
    "builder.unpublishPage": "Unpublish Page",
    "builder.unpublishing": "Unpublishing...",
    "builder.publishPage": "Publish Page",
    "builder.viewLivePage": "View Live Page",
    "builder.updating": "Updating...",
    "builder.liveAt": "Live at:",
    "builder.status": "Status:",
    "builder.readyToPublish": "Ready to publish",
    "builder.desktopView": "Desktop View",
    "builder.tabletView": "Tablet View",
    "builder.mobileView": "Mobile View",
    "builder.resetZoom": "Reset zoom",

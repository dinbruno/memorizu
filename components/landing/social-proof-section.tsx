        ...
        <div className="text-center space-y-4 mb-16">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Don't just take our word for it. Here's what real users say about creating their special event pages with
              Memorizu.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              {/* Event Badge */}
              <div className="bg-primary/10 text-primary text-xs px-3 py-1 rounded-full inline-block mb-4">
                {testimonial.event}
              </div>
        ...
        >
          <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white">
            ...
            <p className="mb-6 opacity-90 max-w-2xl mx-auto">
              Start creating beautiful event pages today and see why thousands of users choose Memorizu for their
              special moments.
            </p>
            <motion.button

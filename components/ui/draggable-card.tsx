...
export const DraggableCardBody = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "relative min-h-96 w-80 overflow-hidden rounded-xl bg-white/80 backdrop-blur-sm p-6 shadow-2xl transform-3d dark:bg-neutral-900/80 border border-white/20",
        className,
      )}
    >
      {children}
